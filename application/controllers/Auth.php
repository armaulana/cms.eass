...
class Auth extends CI_Controller {
	...
	public function __construct(){
		...
		$this->lang->load('auth');
		//$semester_id = $this->db->where('periode_aktif', 1)->get('bc_indag_p_ref_semester')->row();
		//$this->session->set_userdata('semester',$semester_id->semester_id);
	}
	...
	public function login(){
		//echo $pass = $this->ion_auth_model->hash_password('m4l41k4tm1k41L',FALSE,FALSE);
		//exit();
		if (!$this->ion_auth->logged_in()){
			...
			if ($this->form_validation->run() == true){
				...
				if ($this->ion_auth->login($this->input->post('username'), $this->input->post('password'), $remember)){
					...
					redirect('auth/login', 'refresh'); /* Default */
					//redirect('mod_dashboard', 'refresh');
				}
			}else{
				$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
	...
	public function edit_user($id){
		...
		$this->data['title2'] 				= 'Edit Profile';
		$this->data['menu_active_parent'] 	= '';
		$this->data['menu_active_sub'] 		= '';
