...
class myModel extends CI_Model{
    ...
    function _get_datatables_query(){
        if($this->input->post('nama_sub')){
            $this->db->where('a.nama_sub', $this->input->post('nama_sub'));
        }

        if($this->input->post('link_sub')){
            $this->db->like('a.link_sub', $this->input->post('link_sub'));
        }

        $this->db->select('a.id_sub, b.icon, b.nama_menu, a.nama_sub,a.link_sub,a.id_main,a.urutan as urutan_sub, b.urutan as urutan_main');
    ...
    function update($where, $data){
        $this->db->update('submenu', $data, $where);
    ...
    function delete_by_id_user_access($id){
        $this->db->where('users_sub_menu_id', $id);
