                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="user_name" value="<?php echo $get_data->username; ?>" placeholder="User Name ..." class="form-control" id="redcolor">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input name="password" value="<?php echo $get_data->password; ?>" placeholder="Password ..." class="form-control" type="password" id="redcolor2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <?php foreach($wn as $key=> $x_value){ ?>
                                                        <option <?php if($get_data->active == $x_value){ echo "selected=''"; }else{} ?> value="<?php echo $key; ?>" ><?php echo $x_value; ?></option>
                                                <?php } ?> 
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input name="first_name" value="<?php echo $get_data->first_name; ?>" placeholder="First Name ..." class="form-control" type="text" id="nama">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input name="last_name" value="<?php echo $get_data->last_name; ?>" placeholder="Last Name ..." class="form-control" type="text" id="nama">
                                                <small style="color: #666"><b>Max len :</b> 250 , <b>Type : </b> Alfabet </small>
                                            </div>
                                        </div>
                                </div>
                                <div class="col-md-6"> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="phone" value="<?php echo $get_data->phone; ?>" placeholder="Phone ... ">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <?php foreach($wn as $key=> $x_value){ ?>
                                                        <option <?php if($get_data->jenis_kelamin == $x_value ){ echo "selected=''";}else{}?> value="<?php echo $key; ?>" ><?php echo $x_value; ?></option>
                                                <?php } ?> 
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <textarea class="form-control" name="alamat" placeholder="Alamat ... "><?php echo $get_data->alamat; ?></textarea>
            ...
            if(data.status) {
                swal({
                      ...
                      confirmButtonText : 'Ok',
                            ...
                            window.location.href='<?php echo base_url()?>mod_sdm';
                }, 1000); 
            }else{
