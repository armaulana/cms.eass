                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="box-body box-profile" style="padding-top: 25px">
                                      <img  class="profile-user-img img-responsive img-circle" 
                                            src="<?php echo base_url()?>assets/admin/man-user.png" 
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="user_level" disabled>
                                            <option value="">-- Pilih --</option>
                                            <?php foreach($groups as $key){ ?>
                                                        <option <?php if($key->id == $get_data->users_level_id){ echo "selected";}else{ echo ""; } ?> value="<?php echo $key->id;?>"><?php echo $key->name; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="user_name" value="<?php echo $get_data->username; ?>" class="form-control" placeholder="User Name" disabled/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="email" value="<?php echo $get_data->email; ?>" class="form-control" placeholder="Email" disabled/>
