...
class MyModel extends CI_Model{
    ...
    function _get_datatables_query(){
        if($this->input->post('nama_album')){
            $this->db->like('b.nama_album', $this->input->post('nama_album'));
        }
        $this->db->select('b.id, b.id as id_album, b.nama_album, COUNT(a.id_album) as total');
        $this->db->where('a.is_trash', 1);
        $this->db->from('bucket_album_foto a');
        $this->db->join('bucket_album_name b', 'b.id = a.id_album', 'left');
