                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th ><i class="fa fa-info"></i>&nbsp; Nama Desa</th>
                                <th >Stat</th>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="id_kecamatan_fk">
...
$(document).ready(function(){
    table = $('#table').DataTable({ 
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('mod_desa/ajax_list')?>",
            "type": "POST"
        },
        "columnDefs": [{ 
...
function edit_posting(id){
    window.location.href='<?php echo base_url()?>mod_desa/rubah/'+id;
}

function detail_posting(id){
    save_method = 'update';
    $.ajax({
        url : "<?php echo site_url('mod_desa/ajax_edit/')?>" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data){
            ...
            $('[name="id_kecamatan_fk"]').val(data.id_kecamatan_fk).attr('disabled', true);
            $('[name="id_desa"]').val(data.id_desa).attr('disabled', true);
            $('[name="nama_desa"]').val(data.nama_desa).attr('disabled', true);
            ...
            $('#photo-preview').show().attr('disabled', true);
        },
...
function delete_posting(id){
    if(confirm('Are you sure delete this data?')){
        $.ajax({
            url : "<?php echo site_url('mod_desa/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data){
                swal({
