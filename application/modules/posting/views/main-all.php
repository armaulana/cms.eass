      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="post-entry-2 d-flex">
              ...
              <div class="contents">
                ...
                <div class="post-meta">
                  <span class="d-block"><a href="#"><?php $user = $this->db->where('id', $key->insert_by)->get('users')->result(); print_r($user[0]->username); ?></a> </span>
          ...
          <div class="col-lg-4">
            ...
            <?php $no = 1; foreach($popular_posting as $key){ ?>
        ...
        <div class="row">
          <div class="col-lg-6">
            <center><div style="padding-left: 16px"><?php echo $this->pagination->create_links(); ?></div></center>
          </div>
        </div>
      </div>
    </div>