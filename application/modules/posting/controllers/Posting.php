...
class Posting extends CI_Controller {
	...
	public function category($id_kat = null){
			$this->load->library('pagination');
			//konfigurasi pagination
	        $config['base_url'] = site_url('posting/index'); //site url
	        $config['total_rows'] = $this->db->where('id_kat', $id_kat)->count_all('bucket_posting'); //total row
	...
	function index($slug = null){ 
		$search = $this->db->select('count(*) as count')->where('slug', $slug)->get('bucket_posting')->row();
