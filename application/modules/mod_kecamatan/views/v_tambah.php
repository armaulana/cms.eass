                            ...
                            <div class="col-md-12"> 
                                ...
                                <label class="control-label col-md-2">Provinsi </label>
                                    <div class="col-md-9">
                                        ...
                                        <small><b id="altFormInput1"></b> <b>Type : Text</b></small>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="nomor" placeholder="Nomor ... " id="colFormInput3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="nama_kecamatan" placeholder="Nama Kecamatan... " id="colFormInput4">
...
function reload(){
    window.location.href='<?php echo base_url()?>mod_kecamtan/tambah';
}

function save(){
    var url;
    var formData = new FormData($('#form')[0]);
    url = "<?php echo site_url('mod_kecamatan/ajax_add')?>";
