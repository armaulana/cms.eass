...
class MyModel extends CI_Model{
    ...
    function _get_datatables_query(){
        $this->db->select('a.lib_id, a.id_kecamatan, c.nama_provinsi, b.nama_kota, a.nama_kecamatan, a.status');
        $this->db->join('bucket_ref_kota b', 'a.id_kota_fk=b.id_kota', 'left');
        $this->db->join('bucket_ref_provinsi c', 'b.id_provinsi_fk=c.id_provinsi', 'left');
        $this->db->order_by('a.id_provinsi_fk', 'ASC');
        $this->db->from('bucket_ref_kecamatan a');
        $i = 0;
    ...
    function cek_id($id){
        ...
        $this->db->from('bucket_ref_kecamatan');
    ...
    function get_selected_by_id_kecamatan($id_kecamatan){
