...
class MyModel extends CI_Model{
    ...
    function _get_datatables_query(){
        $this->db->select('a.lib_id, a.id_provinsi_fk, a.nama_kota, a.id_kota, a.status, b.nama_provinsi');
        $this->db->join('bucket_ref_provinsi b', 'b.id_provinsi=a.id_provinsi_fk');
        $this->db->from('bucket_ref_kota a');
    ...
    public function get_selected_by_id_kecamatan($id_kecamatan){
        ...
        $this->db->join('bucket_ref_kota a', 'c.id_kota_fk = a.id_kota');
        $this->db->join('bucket_ref_provinsi b', 'a.id_provinsi_fk = b.id_provinsi');
        return $this->db->get('bucket_ref_kecamatan c')->row();
    }
